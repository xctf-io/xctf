...
/**
 * @generated from protobuf message ctfg.HighlightArea
 */
export interface HighlightArea {
    ...
    width: number;
    /**
     * @generated from protobuf field: uint32 pageIndex = 3;
     */
    pageIndex: number;
    /**
...
export interface SubmitCommentsRequest {
    ...
    content: string;
    /**
     * @generated from protobuf field: repeated ctfg.HighlightArea areas = 4;
     */
    areas: HighlightArea[];
    /**
     * @generated from protobuf field: string quote = 5;
     */
    quote: string;
}
/**
...
// @generated message type with reflection information, may provide speed optimized methods
class HighlightArea$Type extends MessageType<HighlightArea> {
    constructor() {
        super("ctfg.HighlightArea", [
    ...
    create(value?: PartialMessage<HighlightArea>): HighlightArea {
        const message = { height: 0, width: 0, pageIndex: 0, top: 0, left: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<HighlightArea>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HighlightArea): HighlightArea {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: HighlightArea, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 height = 1; */
        if (message.height !== 0)
        ...
        if (message.pageIndex !== 0)
            writer.tag(3, WireType.Varint).uint32(message.pageIndex);
        /* int32 top = 4; */
        if (message.top !== 0)
            writer.tag(4, WireType.Varint).int32(message.top);
        /* int32 left = 5; */
        if (message.left !== 0)
            writer.tag(5, WireType.Varint).int32(message.left);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message ctfg.HighlightArea
 */
export const HighlightArea = new HighlightArea$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SubmitCommentsRequest$Type extends MessageType<SubmitCommentsRequest> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string content */ 3:
                    message.content = reader.string();
                    break;
                case /* repeated ctfg.HighlightArea areas */ 4:
                    message.areas.push(HighlightArea.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* string quote */ 5:
    ...
    internalBinaryWrite(message: SubmitCommentsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.content !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.content);
        /* repeated ctfg.HighlightArea areas = 4; */
        for (let i = 0; i < message.areas.length; i++)
            HighlightArea.internalBinaryWrite(message.areas[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* string quote = 5; */
        if (message.quote !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.quote);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
