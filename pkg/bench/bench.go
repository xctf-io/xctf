...
func init() {
	...
	flag.BoolVar(&useHttp2, "http", true, "Use HTTP/2")
}
...
func main() {
	...
	loadGen := NewLoadCfg(duration, goroutines, testUrl, reqBody, method, host, header, statsAggregator, timeoutms,
		allowRedirectsFlag, disableCompression, disableKeepAlive, skipVerify, clientCert, clientKey, caCert, useHttp2)
