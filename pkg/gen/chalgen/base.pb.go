...
var file_chalgen_base_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x63, 0x68, 0x61, 0x6c, 0x67, 0x65, 0x6e, 0x22, 0xe7, 0x01,
	...
	0x65, 0x6e, 0x2e, 0x45, 0x78, 0x69, 0x66, 0x48, 0x00, 0x52, 0x04, 0x65, 0x78, 0x69, 0x66, 0x42,
	0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x2e, 0x0a, 0x04, 0x45, 0x78, 0x69, 0x66, 0x12,
	...
	0x6e, 0x74, 0x73, 0x22, 0x34, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x75,
	0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75,
	0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x62, 0x69, 0x6f, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x62, 0x69, 0x6f, 0x22, 0x3c, 0x0a, 0x04, 0x50, 0x6f, 0x73,
...
var file_chalgen_base_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_chalgen_base_proto_goTypes = []interface{}{
	(*Challenge)(nil),    // 0: chalgen.Challenge
	(*Exif)(nil),         // 1: chalgen.Exif
	(*PCAP)(nil),         // 2: chalgen.PCAP
	(*Packet)(nil),       // 3: chalgen.Packet
	(*CaesarCipher)(nil), // 4: chalgen.CaesarCipher
	(*Base64)(nil),       // 5: chalgen.Base64
	(*Twitter)(nil),      // 6: chalgen.Twitter
	(*User)(nil),         // 7: chalgen.User
	(*Post)(nil),         // 8: chalgen.Post
	(*Comment)(nil),      // 9: chalgen.Comment
}
var file_chalgen_base_proto_depIdxs = []int32{
	5, // 0: chalgen.Challenge.base64:type_name -> chalgen.Base64
	6, // 1: chalgen.Challenge.twitter:type_name -> chalgen.Twitter
	4, // 2: chalgen.Challenge.caesar:type_name -> chalgen.CaesarCipher
	2, // 3: chalgen.Challenge.pcap:type_name -> chalgen.PCAP
	1, // 4: chalgen.Challenge.exif:type_name -> chalgen.Exif
	3, // 5: chalgen.PCAP.packets:type_name -> chalgen.Packet
	7, // 6: chalgen.Twitter.users:type_name -> chalgen.User
	8, // 7: chalgen.Twitter.posts:type_name -> chalgen.Post
	9, // 8: chalgen.Twitter.comments:type_name -> chalgen.Comment
